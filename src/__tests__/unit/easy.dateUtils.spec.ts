...
describe('getDaysInMonth', () => {
  ...
  it('유효하지 않은 월에 대해 적절히 처리한다', () => {
    expect(() => getDaysInMonth(2024, 14)).toThrow('Invalid month');
  });
});
...
describe('getWeekDates', () => {
  ...
  it('주의 끝(일요일)에 대해 올바른 주의 날짜들을 반환한다', () => {
    const weekDates = getWeekDates(new Date('2024-07-14'));
    expect(weekDates).toEqual([
      new Date('2024-07-14'),
      new Date('2024-07-15'),
      new Date('2024-07-16'),
...
describe('formatWeek', () => {
  it('월의 중간 날짜에 대해 올바른 주 정보를 반환한다', () => {
    const week = formatWeek(new Date('2024-07-10'));
    expect(week).toBe('2024년 7월 2주');
  });

  it('월의 첫 주에 대해 올바른 주 정보를 반환한다', () => {
    const week = formatWeek(new Date('2024-07-01'));
    expect(week).toBe('2024년 7월 1주');
  });

  it('월의 마지막 주에 대해 올바른 주 정보를 반환한다', () => {
    const week = formatWeek(new Date('2024-07-31'));
    expect(week).toBe('2024년 8월 1주');
  });
